...
import 'package:portfoliosite/widget/projectCard.dart';
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ListView.separated(
              ...
              itemCount: 7,
              //TODO: check that item count corresponds with number of projects
            ),
          ),
          SizedBox(
            height: height * 0.02,
          ...
          OutlinedCustomBtn(
              btnText: "See More",
              onPressed: () {
                launchURL("https://github.com/steph9600");
              })
        ],
      ),
    );
