...
import 'package:portfoliosite/widget/serviceCard.dart';
      ...
      child: Column(
        children: [
          ...
          CustomSectionSubHeading(
              text:
                  "I may not be perfect, but I'm definitely of some help :)\n\n"),
          Column(
            children: [
              Row(
                      ...
                      content: Column(
                        ...
                        children: [
                          CustomFilledBtn(
                            height: 40.0,
                            onPressed: () => launchURL(
                                "https://wa.me/+2349018400014?text=Hi%20Stephen!%20"),
                          ...
                          CustomFilledBtn(
                            height: 40.0,
                            onPressed: () =>
                                launchURL("https://instagram/tech_schematics"),
                            btnColor: Colors.orangeAccent,
                            child: Row(
                              mainAxisSize: MainAxisSize.min,
                              children: [
                                Image.network(
                                  "https://img.icons8.com/ios-filled/50/000000/instagram.png",
                                  height: 35.0,
                                  color: Colors.white,
                                ),
                                const SizedBox(width: 8.0),
