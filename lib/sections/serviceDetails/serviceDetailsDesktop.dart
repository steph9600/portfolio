...
class ServiceDetailsDesktop extends StatelessWidget {
  ...
  const ServiceDetailsDesktop(
      {required this.details, required this.serviceTitle});
  @override
...
class ServiceDetailsDescription extends StatelessWidget {
  ...
  const ServiceDetailsDescription(
      {required this.desc, required this.serviceTitle});
  @override
  Widget build(BuildContext context) {
    final _themeProvider = Provider.of<ThemeProvider>(context);
    return Container(
        ...
        children: [
          ...
          serviceTitle == kServicesTitles[0]
              ? Row(
                  ...
                  children: [
                    ...
                    const SizedBox(width: 8.0),
                    AdaptiveText(
                      "I don't have a MacBook, that's why I only work with Android/Web",
                      style: TextStyle(
                          color: _themeProvider.lightTheme
                              ? Colors.black
                              : Colors.white),
          ...
          Align(
            ...
            child: CustomFilledBtn(
              height: 40.0,
              onPressed: () =>
                  launchURL("https://www.instagram.com/tech_schematics"),
