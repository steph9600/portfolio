...
import 'package:portfoliosite/animations/entranceFader.dart';
import 'package:portfoliosite/constants.dart';
import 'package:portfoliosite/sections/about/about.dart';
import 'package:portfoliosite/sections/contact/contact.dart';
import 'package:portfoliosite/sections/home/home.dart';
import 'package:portfoliosite/sections/navBar/navBarLogo.dart';
import 'package:portfoliosite/sections/portfolio/portfolio.dart';
import 'package:portfoliosite/sections/services/services.dart';
import 'package:portfoliosite/widget/arrowOnTop.dart';
import 'package:portfoliosite/widget/footer.dart';
...
class _MainPageState extends State<MainPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return width < 760
        ? Scaffold(
            ...
            backgroundColor:
                _themeProv.lightTheme ? Colors.white : Colors.black,
            appBar: AppBar(
            ...
            drawer: _appBarMobile(_themeProv),
            body: Stack(
              children: [
                SectionsBody(
        ...
        : Scaffold(
            ...
            appBar: PreferredSize(
              ...
              //TODO: this may not work. come back here to debug
              child: appBarTabDesktop(_themeProv),
            ),
            body: Stack(
              children: [
                SectionsBody(
  ...
  Widget appBarTabDesktop(ThemeProvider _themeProv) {
    return AppBar(
      elevation: 0.0,
